...
This guide lists the manual setup required outside the repo. The current scaffold already reserves the frontend and Worker directories, but the Worker runtime is still only a placeholder at this stage.
...
13. Run D1 migrations after schema files are added in a later step.
